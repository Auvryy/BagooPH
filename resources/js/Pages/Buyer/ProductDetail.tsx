...
export default function BuyerProductDetail({
    ...
    // Gallery images combining primary + multi-angle shots + variant edition photos
    const rawImages = [
        ...
        ...(colorsList.map(c => c.image_url).filter(Boolean) as string[]),
    ];
                    ...
                    <div className="lg:col-span-7 space-y-6">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between text-xs font-mono">
                                    <span className="text-slate-500 font-bold uppercase">
                                        {variations?.option1_name || 'Color / Edition'}:
                                    </span>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {colorsList.map((color) => (
                                        <button
                                            ...
                                            className={`px-3 py-1.5 rounded-xl border flex items-center gap-2 text-xs font-bold transition ${
                                                selectedColor?.id === color.id
                                                    ? 'border-[#E00D42] bg-[#E00D42]/5 text-[#E00D42] shadow-2xs ring-1 ring-[#E00D42]'
                                        ...
                                        >
                                            ...
                                            {selectedColor?.id === color.id && <Check className="w-3 h-3 shrink-0 text-[#E00D42]" />}
                                        </button>
                                    ))}
                                </div>
                            </div>
                        ...
                        {sizesList.length > 0 && (
                            <div className="space-y-2">
                                <div className="flex items-center justify-between text-xs font-mono">
                                    <span className="text-slate-500 font-bold uppercase">
                                        {variations?.option2_name || 'Specification / Size'}:
                                    </span>
