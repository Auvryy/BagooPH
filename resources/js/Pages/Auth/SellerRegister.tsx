        ...
        >
            ...
            <div className="mb-6 space-y-2">
                <div className="flex items-center justify-between text-xs font-mono font-bold">
                    <span className="text-[#E00D42] uppercase tracking-wider">
                        Step {currentStep} of 3: {currentStep === 1 ? 'Store Identity' : currentStep === 2 ? 'Pickup Location' : 'KYC & Security'}
                    </span>
                ...
                <div className="w-full bg-slate-200 h-1.5 rounded-full overflow-hidden">
                    <div 
                        className="bg-[#E00D42] h-full transition-all duration-300 rounded-full"
                ...
                <div className="grid grid-cols-3 gap-2 pt-2 font-mono text-[11px]">
                    <div className={`p-2 rounded-lg border text-center transition ${
                        currentStep === 1 
                            ? 'bg-rose-50 border-[#E00D42] text-[#E00D42] font-bold' 
                            : currentStep > 1 
                            ? 'bg-slate-100 border-slate-300 text-slate-700 font-bold' 
                            : 'bg-white border-slate-200 text-slate-400'
                    }`}>
                        <span className="flex items-center justify-center gap-1">
                            {currentStep > 1 ? <Check className="w-3.5 h-3.5 text-emerald-600" /> : '1.'} Store Info
                        </span>
                    </div>
                    ...
                    <div className={`p-2 rounded-lg border text-center transition ${
                        ...
                        <span className="flex items-center justify-center gap-1">
                            {currentStep > 2 ? <Check className="w-3.5 h-3.5 text-emerald-600" /> : '2.'} Location
                        </span>
                    </div>
