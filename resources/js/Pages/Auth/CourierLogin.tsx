            ...
            <form onSubmit={submit} className="space-y-4 font-mono">
                ...
                <div className="pt-2">
                    <button
                        type="submit"
                        disabled={processing}
                        className="w-full py-3 bg-emerald-700 hover:bg-emerald-800 active:scale-[0.98] text-white font-bold text-xs rounded-lg shadow-xs transition uppercase tracking-wider flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                ...
                <div className="pt-4 border-t border-slate-200 space-y-3 font-sans text-xs">
                    <div className="p-3 rounded-lg bg-[#ECEAE5] border border-black/10 flex items-center justify-between gap-3">
                        ...
                        <Link
                            ...
                            className="px-3 py-1.5 bg-slate-900 hover:bg-black text-white font-mono text-[10px] font-bold uppercase rounded-lg shrink-0 transition"
                        >
                            Apply Now
                        </Link>
                    </div>
