...
export default function Register() {
    ...
    return (
        <GuestLayout maxWidth="5xl" noCard={true}>
            ...
            <div className="bg-white rounded-2xl border border-black/15 shadow-2xl relative overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[640px]">
                ...
                <div className="lg:col-span-7 p-6 sm:p-8 lg:p-10 flex flex-col justify-between">
                    <div>
                        ...
                        <div className="mb-5 pb-3 border-b border-black/10">
                            ...
                            <p className="text-xs text-black/60 font-mono mt-1 uppercase">
                                Shop across verified merchants with live doorstep telemetry
                            </p>
                        </div>

                        {/* NUMBERED STEPS PILLS */}
                        ...
                        <form onSubmit={submit} className="space-y-4 font-mono">
                                ...
                                <div className="space-y-3.5 animate-fade-in">
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    name="password"
                                                    value={data.password}
                                                    className="w-full pl-9 pr-10 py-2 text-xs bg-white border border-slate-300 rounded-lg focus:border-[#E00D42] focus:ring-1 focus:ring-[#E00D42] outline-hidden font-mono transition text-slate-900 placeholder-slate-400"
                                                    placeholder="••••••••••••"
                                    ...
                                    <div className="pt-2">
                                        <button
                                            type="button"
                                            onClick={handleNext}
                                            className="w-full py-2.5 bg-[#E00D42] hover:bg-[#C20836] active:scale-[0.98] text-white font-bold text-xs rounded-lg shadow-xs transition uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer"
                                        >
                                            <span>Continue to Shipping Details</span>
                            ...
                            {currentStep === 2 && (
                                <div className="space-y-3.5 animate-fade-in">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                name="city"
                                                value={data.city}
                                                className="w-full px-3 py-2 text-xs bg-white border border-slate-300 rounded-lg focus:border-[#E00D42] focus:ring-1 focus:ring-[#E00D42] outline-hidden font-mono transition text-slate-900 placeholder-slate-400"
                                    ...
                                    {/* Optional Valid ID Upload Dropzone */}
                                    <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl space-y-1.5">
                                        <div className="flex items-center justify-between">
                                            <label className="block text-[11px] font-bold text-slate-800 uppercase tracking-wider">
                                                Valid Government ID <span className="text-slate-400 font-normal">(Optional)</span>
                                            </label>
                                            <span className="text-[10px] text-emerald-700 bg-emerald-100/70 border border-emerald-300 px-1.5 py-0.5 rounded font-bold uppercase">
                                                Browse Unrestricted
                                            </span>
                                        </div>
                                        <p className="text-[10px] text-slate-500 leading-normal">
                                            Upload now or later when placing an order. You can browse and add items to your bag immediately.
                                        </p>
                                        ...
                                        {!fileName ? (
                                            <div 
                                                ...
                                                className="border-2 border-dashed border-slate-300 hover:border-[#E00D42] hover:bg-white rounded-lg p-2.5 text-center cursor-pointer transition flex items-center justify-center gap-2 bg-white"
                                            >
                                                <Upload className="w-4 h-4 text-slate-400" />
                                                <span className="text-[11px] text-slate-600">Choose ID File (JPG, PNG, PDF max 5MB)</span>
                                            </div>
                                        ) : (
                                    ...
                                    <div className="flex items-center gap-3 pt-2">
                                        <button
                                            type="button"
                                            onClick={handlePrev}
                                            className="w-1/3 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold text-xs rounded-lg transition uppercase tracking-wider flex items-center justify-center gap-1.5 cursor-pointer"
                                        >
                                        ...
                                        <button
                                            type="submit"
                                            disabled={processing}
                                            className="w-2/3 py-2.5 bg-[#E00D42] hover:bg-[#C20836] active:scale-[0.98] text-white font-bold text-xs rounded-lg shadow-xs transition uppercase tracking-wider flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
                                        >
                    ...
                    {/* Switchers & Role Gateways */}
                    <div className="pt-4 mt-4 border-t border-slate-200 space-y-3 font-sans text-xs">
